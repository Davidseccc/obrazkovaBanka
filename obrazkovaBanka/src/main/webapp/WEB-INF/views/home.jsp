...
<link href="/obrazkovaBanka/resources/css/dropzone.css" type="text/css"
	rel="stylesheet" />
...
<body>
	...
	<div class="center-block" style="width: 500px; padding: 20px;">
		...
		<input style="padding-bottom: 20px; margin: 0 auto 0 auto"
			id="fileupload" type="file" name="files[]"
			data-url="controller/savefiles" multiple>

		<div id="dropzone" class="center-block fade well">Drop files
			here</div>
		<p class="text-center small text-muted">
			Supported content path:
			<kbd class="kdb-grey">image/bmp</kbd>
			,
			<kbd class="kdb-grey">image/jpeg</kbd>
			and
			<kbd class="kdb-grey">image/png</kbd>
		</p>
	...
	<div class="center-block" style="width: 90%; padding-top: 20px;"
		...
		<div class="clearfix">
			<p class="text-muted center col-sm-12">The time on the server is
				${serverTime}.</p>
		</div>
